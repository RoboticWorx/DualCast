...
/*
 * Hi Justin (or who(m)ever), it's Justin. These are my LVGL notes:
 * - When I had "fatal" include errors for no reason I right clicked the lvgl folder > "add/remove include paths" > OK.
 *   Going through project > properties to do the same thing didn't work for some reason.
 * - Remember to delete/exclude the "tests" folder and add whichever tick source you're using to the timebase.
 */
